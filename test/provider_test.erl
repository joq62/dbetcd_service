...
%    io:format("AllProviders ~p~n",[{AllProviders,?MODULE,?FUNCTION_NAME}]),
...

    {
     ...
     " -pa dbetcd_appl/_build/default/lib/*/ebin -config dbetcd_appl/config/sys.config",
    ...
    {ok," -pa dbetcd_appl/_build/default/lib/*/ebin -config dbetcd_appl/config/sys.config"}=rpc:call(Node,db_provider_spec,read,[pa_args,"dbetcd_appl"],5000),
